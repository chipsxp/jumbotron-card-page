...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="/easy-icon.png">
    ...
    <!--Custom Style-->
    <link rel="stylesheet" href="/wp-content/themes/newblogtheme/style.css">
    ...
    <header id="siteHeader">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">WhatUp Company</a>
      ...
      <h1 class="siteTitle">What's Up?!, World!</h1>
    </header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-4">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Happy Hours</h5>
              <p class="card-text">Some more ways to quickly fill in the spaces.Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        ...
        <div class="col-12 col-md-4">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Happy Days</h5>
              <p class="card-text">Some more ways to quickly fill in the spaces.Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              <a href="#" class="btn btn-primary">Go somewhere</a>
            </div>
          </div>
        ...
        <div class="col-12 col-md-4">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Happy Weeks</h5>
              <p class="card-text">Some more ways to quickly fill in the spaces.Quick example text to build on the card title and make up the bulk of the card's content.</p>
              <a href="#" class="btn btn-primary">Go somewhere</a>
            </div>
          </div>
        </div>
